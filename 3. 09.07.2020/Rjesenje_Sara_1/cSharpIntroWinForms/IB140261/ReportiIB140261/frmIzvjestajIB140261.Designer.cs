...
namespace cSharpIntroWinForms.IB140261.ReportiIB140261
{
    partial class frmIzvjestajIB140261
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.dsDLWMS = new cSharpIntroWinForms.IB140261.ReportiIB140261.dsDLWMS();
            ...
            reportDataSource1.Name = "dsPredmeti";
            reportDataSource1.Value = this.PredmetiBindingSource;
            this.reportViewer1.LocalReport.DataSources.Add(reportDataSource1);
            this.reportViewer1.LocalReport.ReportEmbeddedResource = "cSharpIntroWinForms.IB140261.ReportiIB140261.rptPredmeti.rdlc";
            ...
            this.PredmetiBindingSource.DataSource = this.dsDLWMS;
            // 
